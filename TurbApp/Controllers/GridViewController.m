...
@interface FHGMediaPickerController ()
...
@interface FHGGridViewController () <PHPhotoLibraryChangeObserver>
...
NSString * const FHGGridViewCellIdentifier = @"FHGGridViewCellIdentifier";

@implementation FHGGridViewController
{
    CGFloat screenWidth;
...
-(instancetype)initWithPicker:(FHGMediaPickerController *)picker
{
    ...
    if (self = [super initWithCollectionViewLayout:layout]) {
        ...
        [self.collectionView registerClass:FHGGridViewCell.class
                forCellWithReuseIdentifier:FHGGridViewCellIdentifier];
...
- (void)setupButtons
{
    ...
    NSString *cancelTitle = @"Cancel"; //NSLocalizedStringFromTableInBundle(@"picker.navigation.cancel-button",  @"FHGMedia", [NSBundle bundleForClass:FHGMediaPickerController.class], @"Cancel");
...
{
    FHGGridViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:FHGGridViewCellIdentifier
...
- (BOOL)collectionView:(UICollectionView *)collectionView shouldSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    FHGGridViewCell *cell = (FHGGridViewCell *)[collectionView cellForItemAtIndexPath:indexPath];
