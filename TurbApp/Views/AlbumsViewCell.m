...
#import "AlbumsViewCell.h"
#import "../Controllers/AlbumsViewController.h"

@import QuartzCore;

@implementation FHGAlbumsViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        [allImagesView addSubview:_imageView3];
        ...
        [allImagesView addSubview:_imageView2];
        ...
        [allImagesView addSubview:_imageView1];
        ...
        _videoIcon.image = [UIImage imageNamed:@"PickerVideoIcon"];
        ...
        _mainLabel = [[UILabel alloc] initWithFrame:CGRectMake(0.0, 0.0, 220.0, 15.0)];
        _mainLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:17.0];
        _mainLabel.text = @"x";
        _mainLabel.numberOfLines = 1;
        _mainLabel.adjustsFontSizeToFitWidth = YES;
        _mainLabel.contentMode = UIViewContentModeScaleAspectFill;
        _mainLabel.clipsToBounds = YES;
        _mainLabel.translatesAutoresizingMaskIntoConstraints = NO;
        _mainLabel.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleHeight;
        
        _detailLabel = [[UILabel alloc] initWithFrame:CGRectMake(225.0, 0.0, 80.0, 45.0)];
        _detailLabel.text = @"y";
        _detailLabel.numberOfLines = 1;
        _detailLabel.adjustsFontSizeToFitWidth = YES;
        _detailLabel.contentMode = UIViewContentModeScaleAspectFill;
        _detailLabel.clipsToBounds = YES;
        _detailLabel.translatesAutoresizingMaskIntoConstraints = NO;
        _detailLabel.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleHeight;
        
        [self.contentView addSubview:_mainLabel];
        [self.contentView addSubview:_detailLabel];
        [self.contentView addSubview:allImagesView];
        
        [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[imageView1]-(offset)-[label1]-|"
                                                                                 options:0
                                                                                 metrics:@{@"offset": @(kAlbumImageToTextSpace)}
                                                                                   views:@{@"label1": _mainLabel,
                                                                                           @"imageView1": self.imageView1}]];
        ////
        [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[imageView1]-(offset)-[label2]-|"
                                                                                 options:0
                                                                                 metrics:@{@"offset": @(kAlbumImageToTextSpace)}
                                                                                   views:@{@"label2": _detailLabel,
                                                                                           @"imageView1": self.imageView1}]];
        //
        [self.contentView addConstraints:@[[NSLayoutConstraint constraintWithItem:_mainLabel
        ...
        [self.contentView addConstraints:@[[NSLayoutConstraint constraintWithItem:_detailLabel
    ...
    //        _mainTextView.backgroundColor = self.backgroundColor;
    //        _mainTextView.font = [UIFont fontWithName:@"HelveticaNeue" size:17.0];
    //        _mainTextView.translatesAutoresizingMaskIntoConstraints = NO;
    //        _mainTextView.adjustsFontForContentSizeCategory = YES;
    //        [self.contentView addSubview:_mainTextView];
    //
    //        _detailsTextView = [[UITextView alloc] init];
    //        _detailsTextView.backgroundColor = self.backgroundColor;
    //        _detailsTextView.font = [UIFont fontWithName:@"HelveticaNeue" size:17.0];
    //        _detailsTextView.translatesAutoresizingMaskIntoConstraints = NO;
    //        _detailsTextView.adjustsFontForContentSizeCategory = YES;
    //        [self.contentView addSubview:_detailsTextView];
    //
    //        [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[imageView1]-(offset)-[mainTextView]-|"
    //                                                                                 options:0
    //                                                                                 metrics:@{@"offset": @(kAlbumImageToTextSpace)}
    //                                                                                   views:@{@"mainTextView": self.mainTextView,
    //                                                                                           @"imageView1": self.imageView1}]];
    //////
    //        [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[imageView1]-(offset)-[detailsTextView]-|"
    //                                                                                 options:0
    //                                                                                 metrics:@{@"offset": @(kAlbumImageToTextSpace)}
    //                                                                                   views:@{@"detailsTextView": self.detailsTextView,
    //                                                                                           @"imageView1": self.imageView1}]];
    ////
    //        [self.contentView addConstraints:@[[NSLayoutConstraint constraintWithItem:self.mainTextView
    //                                                                        attribute:NSLayoutAttributeBottom
    //                                                                        relatedBy:NSLayoutRelationEqual
    //                                                                           toItem:self.textLabel.superview
    //                                                                        attribute:NSLayoutAttributeCenterY
    //                                                                       multiplier:1.f constant:0.f]]];
    //
    //        [self.contentView addConstraints:@[[NSLayoutConstraint constraintWithItem:self.detailsTextView
    //                                                                        attribute:NSLayoutAttributeTop
    //                                                                        relatedBy:NSLayoutRelationEqual
    //                                                                           toItem:self.textLabel.superview
    //                                                                        attribute:NSLayoutAttributeCenterY
