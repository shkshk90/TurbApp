...
@implementation FHGGridViewCell
...
+ (void)initialize
{
    ...
    titleHeight     = 20.0f;
    videoIcon       = [UIImage imageNamed:@"PickerVideoIcon"];
...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        [_selectedButton setImage:[UIImage imageNamed:@"PickerSelected"] forState:UIControlStateSelected];
